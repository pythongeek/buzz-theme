 ...
 * Description: Full-width homepage template for BuzzWire Daily
 *
 * To use as a WordPress theme template:
 * 1. Copy this file to your theme directory as page-buzzwire.php (or front-page.php)
 * 2. Move the <style> block to style.css or enqueue via wp_enqueue_styles()
 * 3. Move the <script> block to assets/js/buzzwire.js and enqueue via wp_enqueue_scripts()
 * 4. Replace static content with WordPress template tags (get_the_title(), the_content(), etc.)
 * 5. Use get_header() and get_footer() to wrap with your theme header/footer
 *
 * Enqueue example (functions.php):
 * function buzzwire_scripts() {
 *   wp_enqueue_style('buzzwire-fonts', 'https://fonts.googleapis.com/css2?...');
 *   wp_enqueue_style('buzzwire-style', get_template_directory_uri().'/style.css');
 *   wp_enqueue_script('three-js', 'https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js', [], null, true);
 *   wp_enqueue_script('buzzwire-main', get_template_directory_uri().'/assets/js/buzzwire.js', ['three-js'], '1.0', true);
 * }
 * add_action('wp_enqueue_scripts', 'buzzwire_scripts');
 */
?>
<!DOCTYPE html>
...
<!-- wp_head() -->
<title><?php /* wp_title('|', true, 'right'); bloginfo('name'); */ ?>BUZZWIRE DAILY — VOID SIGNAL</title>
...
/* ============================================================
   ...
   WordPress-ready: extract to style.css & enqueue via functions.php
...
:root{
  ...
  --c-text-muted:rgba(255,255,255,.35);
  --c-text-dim:rgba(255,255,255,.2);
...
.hh-sub{font-size:var(--fs-body);color:rgba(255,255,255,.35);letter-spacing:.08em;margin-top:8px}
...
.nl-p{font-size:var(--fs-body);color:rgba(255,255,255,.35);line-height:1.8;margin-bottom:32px}
...
<!-- wp_body_open() — WordPress 5.2+ hook -->
...
<header class="nav-hamburger" role="banner">
  <div class="nav-hamburger-logo">Buzz<span>Wire</span></div>
  <button class="hamburger-btn" id="hamburgerBtn" aria-label="Toggle navigation" aria-expanded="false" aria-controls="mobileNavDrawer">
...
<nav id="mobileNavDrawer" class="mobile-nav-drawer" aria-label="Mobile navigation">
  <div class="mobile-nav-item active"><span class="nav-icon">🎤</span>Urban Culture</div>
  <div class="mobile-nav-item"><span class="nav-icon">🎬</span>Films</div>
  <div class="mobile-nav-item"><span class="nav-icon">📺</span>Stream</div>
  <div class="mobile-nav-item"><span class="nav-icon">🌟</span>Creators</div>
  <div class="mobile-nav-item"><span class="nav-icon">🤖</span>AI Lab</div>
  <div class="mobile-nav-item"><span class="nav-icon">₿</span>Crypto</div>
  <div class="mobile-nav-item"><span class="nav-icon">📱</span>Viral</div>
</nav>

<!-- ── DESKTOP VERTICAL NAV ── -->
<nav class="v-nav" aria-label="Site navigation">
  <div class="v-logo">Buzz<span>Wire</span></div>
  <div class="v-divider" role="separator"></div>
  <div class="v-links" role="list">
    <div class="v-link active" role="listitem" tabindex="0" aria-label="Urban Culture">🎤<div class="v-tooltip">Urban</div></div>
    <div class="v-link" role="listitem" tabindex="0" aria-label="Films">🎬<div class="v-tooltip">Films</div></div>
    <div class="v-link" role="listitem" tabindex="0" aria-label="Streaming">📺<div class="v-tooltip">Stream</div></div>
    <div class="v-link" role="listitem" tabindex="0" aria-label="Creators">🌟<div class="v-tooltip">Creators</div></div>
    <div class="v-link" role="listitem" tabindex="0" aria-label="AI Lab">🤖<div class="v-tooltip">AI Lab</div></div>
    <div class="v-link" role="listitem" tabindex="0" aria-label="Crypto">₿<div class="v-tooltip">Crypto</div></div>
    <div class="v-link" role="listitem" tabindex="0" aria-label="Viral">📱<div class="v-tooltip">Viral</div></div>
  </div>
  <div class="v-live" aria-label="Live signal">
    <div class="v-dot" aria-hidden="true"></div>
    <span style="writing-mode:vertical-rl;font-size:7px;letter-spacing:.2em">LIVE</span>
  </div>
</nav>
...
<section class="hero" aria-label="Hero">
  ...
  <div class="hero-eyebrow">Signal Active — May 27 2026</div>
  <h1 class="hero-h1">
    <span class="outline">VOID</span><br>
    <span class="red">SIGNAL</span><br>
    DAILY
  </h1>
  ...
  <div class="hero-scroll" aria-hidden="true"><div class="h-scroll-line"></div>SCROLL</div>
</section>
...
<!-- ── HIP-HOP ── -->
<section class="ns ns-hiphop reveal" id="urban" aria-labelledby="hh-heading">
  <div class="hh-header">
    <div class="hh-label">Section 01 — Urban Culture</div>
    <h2 class="hh-title" id="hh-heading"><span class="white">HIP</span><br>HOP<br><span class="white">&amp; URBAN</span></h2>
    <p class="hh-sub">// Beats. Culture. Streets. Truth.</p>
  </div>
  <div class="hh-grid">
    <article class="hh-card main">
      <div class="hh-big-num" aria-hidden="true">01</div>
      ...
      <div class="freq-bar" aria-hidden="true">
        <div class="freq-b" style="height:20px"></div><div class="freq-b" style="height:26px"></div>
        <div class="freq-b" style="height:16px"></div><div class="freq-b" style="height:28px"></div>
        <div class="freq-b" style="height:22px"></div><div class="freq-b" style="height:18px"></div>
        <div class="freq-b" style="height:24px"></div>
      </div>
      <div class="hh-meta"><span>Marcus Webb · 8 min</span><span class="hh-fire">🔥 42K shares</span></div>
    </article>
    <article class="hh-card">
      <div class="hh-big-num" aria-hidden="true">02</div>
      <div class="hh-cat">Rap Culture</div>
    ...
    <article class="hh-card">
      <div class="hh-big-num" aria-hidden="true">03</div>
      <div class="hh-cat">R&amp;B</div>
    ...
    <article class="hh-card">
      <div class="hh-big-num" aria-hidden="true">04</div>
      <div class="hh-cat">Celebrity</div>
    ...
    <article class="hh-card">
      <div class="hh-big-num" aria-hidden="true">05</div>
      <div class="hh-cat">Battle Rap</div>
...
<!-- ── MOVIES ── -->
<section class="ns ns-movies reveal" id="films" aria-labelledby="mv-heading">
  <div class="film-grain" aria-hidden="true"></div>
  <div class="film-strip-l" aria-hidden="true">
  ...
  <div class="movies-content">
    ...
    <h2 class="mv-title" id="mv-heading">Movies<br>&amp; <span>TV</span></h2>
    <div class="mv-row">
      <article class="mv-card">
        <div class="mv-frame"><div class="mv-img" style="background:linear-gradient(135deg,#0a0010,#1a0a00)"></div><div class="mv-lb-top" aria-hidden="true"></div><div class="mv-lb-bot" aria-hidden="true"></div></div>
        <div class="mv-card-body">
          <div class="mv-score">★★★★½ — Critic Pick</div>
          <h3 class="mv-ttl">Peaky Blinders: The Feature Film — Everything We Know About the Production</h3>
          <p class="mv-ex">Cillian Murphy confirmed. 1920s Birmingham. A story the series couldn't tell in six seasons. Production begins April 2026...</p>
          <div class="mv-meta"><span>Film News</span><span>6 min</span><span style="color:#8B1A1A">Exclusive</span></div>
        </div>
      </article>
      <article class="mv-card">
        <div class="mv-frame"><div class="mv-img" style="background:linear-gradient(135deg,#000814,#001a14)"></div><div class="mv-lb-top" aria-hidden="true"></div><div class="mv-lb-bot" aria-hidden="true"></div></div>
        <div class="mv-card-body">
          <div class="mv-score">Anime — Rising</div>
          <h3 class="mv-ttl">Why Anime Is Outselling Hollywood at the Global Box Office in 2026</h3>
          <p class="mv-ex">The data is undeniable. Three of the top five global box office films this quarter are anime productions...</p>
          <div class="mv-meta"><span>Analysis</span><span>8 min</span></div>
        </div>
      </article>
      <article class="mv-card">
        <div class="mv-frame"><div class="mv-img" style="background:linear-gradient(135deg,#100005,#00050f)"></div><div class="mv-lb-top" aria-hidden="true"></div><div class="mv-lb-bot" aria-hidden="true"></div></div>
        <div class="mv-card-body">
          <div class="mv-score">Streaming</div>
          <h3 class="mv-ttl">Netflix Cancellation Pattern: The Algorithm Killing Prestige TV Before Season 3</h3>
          <p class="mv-ex">We analyzed 200 cancelled shows. The formula emerges — and it has nothing to do with quality...</p>
          <div class="mv-meta"><span>Industry</span><span>10 min</span></div>
        </div>
      </article>
    </div>
  </div>
...
<!-- ── STREAMING ── -->
<section class="ns ns-stream reveal" id="stream" aria-labelledby="st-heading">
  <div class="st-header">
    <div>
      <div class="st-label">Section 03 — Streaming Wars</div>
      <h2 class="st-title" id="st-heading">THE <span>STREAM</span><br>WARS</h2>
    </div>
    <div class="st-status" role="status">● 5 platforms · 1 winner</div>
  </div>
  <div class="st-grid">
    <article class="st-card">
      <div class="st-platforms"><span class="plt plt-nf">Netflix</span><span class="plt plt-di">Disney+</span></div>
      <h3 class="st-ttl">Netflix vs Disney+: The Q1 2026 Subscriber War Just Got Ugly</h3>
      <p class="st-ex">Netflix posted +8M subs while Disney+ lost 3M in the same quarter. The content strategy divergence is now critical mass...</p>
      <div class="st-bar" role="meter" aria-valuenow="78" aria-valuemin="0" aria-valuemax="100"><div class="st-bar-fill" style="width:78%"></div></div>
      <div class="st-meta"><span>Trending 78%</span><span>7 min</span></div>
    </article>
    <article class="st-card">
      <div class="st-platforms"><span class="plt plt-pr">Prime</span><span class="plt plt-fr">Free</span></div>
      <h3 class="st-ttl">The 5 Best Free Streaming Alternatives Cord-Cutters Are Hiding</h3>
      <p class="st-ex">Tubi, Pluto, Peacock Free, Plex, and one platform most people have never heard of...</p>
      <div class="st-bar" role="meter" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"><div class="st-bar-fill" style="width:65%;background:#00FF87"></div></div>
      <div class="st-meta"><span>Guide</span><span>5 min</span></div>
    </article>
    <article class="st-card">
      <div class="st-platforms"><span class="plt plt-hb">Max</span><span class="plt plt-nf">Netflix</span></div>
      <h3 class="st-ttl">Which Streaming Bundle Is Actually Worth It in 2026? We Did the Math</h3>
      <p class="st-ex">Price hikes hit four platforms in Q1. We modeled 12 bundle scenarios against actual watch-time data...</p>
      <div class="st-bar" role="meter" aria-valuenow="91" aria-valuemin="0" aria-valuemax="100"><div class="st-bar-fill" style="width:91%;background:#FFD700"></div></div>
      <div class="st-meta"><span>Hot 91%</span><span>9 min</span></div>
    </article>
  </div>
</section>

<!-- ── INFLUENCERS ── -->
<section class="ns ns-inf reveal" id="creators" aria-labelledby="inf-heading">
  <div class="inf-label">Section 04 — Creators &amp; Influencers</div>
  <h2 class="inf-title" id="inf-heading"><span class="hot">CREATOR</span><br><span class="cold">ECON</span><br>OMY</h2>
  <div class="inf-phones">
    <article class="inf-phone">
      <div class="inf-phone-screen"><div class="inf-screen-bg" style="background:linear-gradient(180deg,#1a0030,#050008)"></div><div class="inf-notch" aria-hidden="true"></div><div class="inf-stats"><span class="inf-stat-chip" style="color:#FF006E">2.4M views</span><span class="inf-stat-chip" style="color:#00D9FF">94% eng</span></div></div>
      <div class="inf-body"><div class="inf-creator">@creator_economy</div><h3 class="inf-ttl">69% of Creators Report Financial Instability in 2026</h3><div class="inf-eng"><span>12K</span> shares · <span>340K</span> views</div></div>
    </article>
    <article class="inf-phone">
      <div class="inf-phone-screen"><div class="inf-screen-bg" style="background:linear-gradient(180deg,#001a30,#000508)"></div><div class="inf-notch" aria-hidden="true"></div><div class="inf-stats"><span class="inf-stat-chip" style="color:#00D9FF">TikTok</span><span class="inf-stat-chip" style="color:#FF006E">Breaking</span></div></div>
      <div class="inf-body"><div class="inf-creator">@algo_watch</div><h3 class="inf-ttl">TikTok's Algorithm 4.0 Just Wiped 40% of Reach Overnight</h3><div class="inf-eng"><span>8.2K</span> shares · <span>240K</span> views</div></div>
    </article>
    <article class="inf-phone">
      <div class="inf-phone-screen"><div class="inf-screen-bg" style="background:linear-gradient(180deg,#1a1000,#050300)"></div><div class="inf-notch" aria-hidden="true"></div><div class="inf-stats"><span class="inf-stat-chip" style="color:#FFD700">Finance</span><span class="inf-stat-chip" style="color:#FF006E">Tool</span></div></div>
      <div class="inf-body"><div class="inf-creator">@brand_deals</div><h3 class="inf-ttl">Brand Deals Are Getting Worse — Here's How to Negotiate Back</h3><div class="inf-eng"><span>6.1K</span> shares · <span>180K</span> views</div></div>
    </article>
    <article class="inf-phone">
      <div class="inf-phone-screen"><div class="inf-screen-bg" style="background:linear-gradient(180deg,#001a0a,#000508)"></div><div class="inf-notch" aria-hidden="true"></div><div class="inf-stats"><span class="inf-stat-chip" style="color:#00D9FF">African</span><span class="inf-stat-chip" style="color:#39FF14">Rising</span></div></div>
      <div class="inf-body"><div class="inf-creator">@afrocreator</div><h3 class="inf-ttl">Nigerian Creators Are the Fastest Growing Influencer Market Globally</h3><div class="inf-eng"><span>9.8K</span> shares · <span>290K</span> views</div></div>
    </article>
  </div>
</section>

<!-- ── AI LAB ── -->
<section class="ns ns-ai reveal" id="ai" aria-labelledby="ai-heading">
  <div class="ai-header">
    <div class="ai-prompt">initialize ai_lab module — buzzwire_daily v2.6</div>
    <h2 class="ai-title" id="ai-heading">AI LAB</h2>
  </div>
  <div class="ai-grid">
    <article class="ai-terminal">
      <div class="ai-term-bar" aria-hidden="true"><div class="ai-dot ai-dot-r"></div><div class="ai-dot ai-dot-y"></div><div class="ai-dot ai-dot-g"></div><div class="ai-term-title">analysis_01.sh</div></div>
      <div class="ai-term-body">
        <div class="ai-cmd">run --compare claude gpt-5 gemini --mode honest</div>
        <h3 class="ai-ttl">Claude vs GPT-5 vs Gemini 2.5: The Honest 2026 Tier List After 200hrs of Testing</h3>
        <p class="ai-ex">We ran 847 standardized prompts across coding, reasoning, creativity, and factual accuracy. The results contradict the marketing...</p>
        <div class="ai-tags"><span class="ai-tag">review</span><span class="ai-tag">comparison</span><span class="ai-tag">12 min</span></div>
        <div class="ai-loading" aria-hidden="true"></div>
      </div>
    </article>
    <article class="ai-terminal">
      <div class="ai-term-bar" aria-hidden="true"><div class="ai-dot ai-dot-r"></div><div class="ai-dot ai-dot-y"></div><div class="ai-dot ai-dot-g"></div><div class="ai-term-title">subscriptions.log</div></div>
      <div class="ai-term-body">
        <div class="ai-cmd">audit --user-subs --find-overlap --output=savings</div>
        <h3 class="ai-ttl">You're Paying $64/Month for 7 AI Subscriptions — And 4 Do the Same Thing</h3>
        <p class="ai-ex">The quiet cost creep hitting power users: ChatGPT Plus, Claude Pro, Gemini Advanced, Perplexity Pro — overlapping at 73%...</p>
        <div class="ai-tags"><span class="ai-tag">finance</span><span class="ai-tag">5 min</span></div>
        <div class="ai-loading" aria-hidden="true"></div>
      </div>
    </article>
    <article class="ai-terminal">
      <div class="ai-term-bar" aria-hidden="true"><div class="ai-dot ai-dot-r"></div><div class="ai-dot ai-dot-y"></div><div class="ai-dot ai-dot-g"></div><div class="ai-term-title">music_tools.sh</div></div>
      <div class="ai-term-body">
        <div class="ai-cmd">test --ai-music --blind --judges=50producers</div>
        <h3 class="ai-ttl">AI Music Production Tools Ranked: Which Actually Sound Human in a Blind Test?</h3>
        <p class="ai-ex">We fed 6 tools the same 16-bar prompt. 50 producers voted blind. The winner surprised everyone — including us...</p>
        <div class="ai-tags"><span class="ai-tag">music</span><span class="ai-tag">hip-hop</span><span class="ai-tag">8 min</span></div>
        <div class="ai-loading" aria-hidden="true"></div>
      </div>
    </article>
    <article class="ai-terminal">
      <div class="ai-term-bar" aria-hidden="true"><div class="ai-dot ai-dot-r"></div><div class="ai-dot ai-dot-y"></div><div class="ai-dot ai-dot-g"></div><div class="ai-term-title">gaming_agents.log</div></div>
      <div class="ai-term-body">
        <div class="ai-cmd">analyze --ai-npc --behavior=adaptive --realtime</div>
        <h3 class="ai-ttl">AI NPCs Are Destroying Game Balance in Real Time — And Players Are Obsessed</h3>
        <p class="ai-ex">Adaptive enemy intelligence that learns your playstyle between sessions. The future of single-player is already here...</p>
        <div class="ai-tags"><span class="ai-tag">gaming</span><span class="ai-tag">web3</span><span class="ai-tag">7 min</span></div>
        <div class="ai-loading" aria-hidden="true"></div>
      </div>
    </article>
  </div>
...
<!-- ── CRYPTO ── -->
<section class="ns ns-crypto reveal" id="crypto" aria-labelledby="cr-heading">
  <div class="cr-label">Section 06 — Crypto &amp; Web3</div>
  <h2 class="cr-title" id="cr-heading">CRYPTO<br>&amp; <span>WEB3</span></h2>
  <div class="cr-ticker-row" role="list" aria-label="Crypto prices">
    <div class="cr-tick" role="listitem"><div class="cr-t-sym">BTC</div><div class="cr-t-price">$94,230</div><div class="cr-t-chg up">▲ +4.2%</div></div>
    <div class="cr-tick" role="listitem"><div class="cr-t-sym">ETH</div><div class="cr-t-price">$3,841</div><div class="cr-t-chg up">▲ +2.8%</div></div>
    <div class="cr-tick" role="listitem"><div class="cr-t-sym">SOL</div><div class="cr-t-price">$187.40</div><div class="cr-t-chg up">▲ +6.1%</div></div>
    <div class="cr-tick" role="listitem"><div class="cr-t-sym">$AGNT</div><div class="cr-t-price">$0.0842</div><div class="cr-t-chg up">▲ +380%</div></div>
    <div class="cr-tick" role="listitem"><div class="cr-t-sym">BNB</div><div class="cr-t-price">$612.20</div><div class="cr-t-chg down">▼ −1.1%</div></div>
    <div class="cr-tick" role="listitem"><div class="cr-t-sym">LINK</div><div class="cr-t-price">$22.40</div><div class="cr-t-chg up">▲ +3.3%</div></div>
  </div>
  <div class="cr-grid">
    <article class="cr-card main">
      <div class="cr-cat">🔥 Featured Analysis</div>
      <h3 class="cr-ttl">Bitcoin at $94K: On-Chain Data Points to $110K — The Signal Institutional Holders Are Sending</h3>
      <p class="cr-ex">Long-term holder accumulation at levels not seen since the 2020 pre-rally. Three on-chain metrics flashing historically rare bullish divergence. Here's what the data actually means for the next 90 days...</p>
      <div class="cr-chart" aria-hidden="true">
        <div class="cr-bar" style="height:60%;width:6px"></div><div class="cr-bar" style="height:45%;width:6px"></div>
        <div class="cr-bar" style="height:70%;width:6px"></div><div class="cr-bar" style="height:55%;width:6px"></div>
        <div class="cr-bar" style="height:80%;width:6px"></div><div class="cr-bar" style="height:65%;width:6px"></div>
        <div class="cr-bar" style="height:90%;width:6px"></div><div class="cr-bar" style="height:75%;width:6px"></div>
        <div class="cr-bar" style="height:100%;width:6px;background:#00FF87"></div>
      </div>
      <div class="cr-meta"><span>Research · 9 min</span><span class="up">+42K views today</span></div>
    </article>
    <article class="cr-card">
      <div class="cr-cat">AI × Crypto</div>
      <h3 class="cr-ttl">AI Agent Tokens: 5 Projects with Real Utility in 2026</h3>
      <p class="cr-ex">Beyond the hype — a utility-first deep dive into the top AI-adjacent crypto plays that might actually survive the cycle.</p>
      <div class="cr-meta"><span>Research · 9 min</span><span class="up">Trending</span></div>
    </article>
    <article class="cr-card">
      <div class="cr-cat">Tax Guide</div>
      <h3 class="cr-ttl">2026 Crypto Tax Rules: The IRS Changes Every Holder Must Know</h3>
      <p class="cr-ex">New cost basis reporting requirements. What changed, what didn't, and how to stay compliant without paying more than you owe.</p>
      <div class="cr-meta"><span>Finance · 10 min</span><span class="down">Action Required</span></div>
    </article>
  </div>
</section>

<!-- ── VIRAL ── -->
<section class="ns ns-viral reveal" id="viral" aria-labelledby="vr-heading">
  <div class="vr-label">Section 07 — Viral &amp; Social</div>
  <h2 class="vr-title" id="vr-heading"><span class="c1">VIRAL</span><br><span class="c2">&amp;</span><br><span class="c3">SOCIAL</span></h2>
  <div class="vr-chaos">
    <article class="vr-card vr-c1"><div class="vr-badge vr-badge-fire">🔥 12K shares</div><h3 class="vr-ttl">TikTok's Algorithm Wipe: 40% Reach Loss Overnight — What You Must Do Now</h3><div class="vr-meter" role="meter" aria-valuenow="92"><div class="vr-meter-fill" style="width:92%;background:#FF6B00"></div></div><div class="vr-shares">Virality: 92 / 100</div><div class="vr-num" aria-hidden="true">01</div></article>
    <article class="vr-card vr-c2"><div class="vr-badge vr-badge-viral">📱 8.4K shares</div><h3 class="vr-ttl">Instagram's New Chronological Feed is Already Being Gamed — Here's How</h3><div class="vr-meter" role="meter" aria-valuenow="78"><div class="vr-meter-fill" style="width:78%;background:#FF006E"></div></div><div class="vr-shares">Virality: 78 / 100</div><div class="vr-num" aria-hidden="true">02</div></article>
    <article class="vr-card vr-c3"><div class="vr-badge vr-badge-trend">✦ Trending</div><h3 class="vr-ttl">The POV Format Is Dead. Here's What Gen Z Is Watching Instead</h3><div class="vr-meter" role="meter" aria-valuenow="65"><div class="vr-meter-fill" style="width:65%;background:#FF006E"></div></div><div class="vr-shares">Virality: 65 / 100</div><div class="vr-num" aria-hidden="true">03</div></article>
    <article class="vr-card vr-c4"><div class="vr-badge vr-badge-fire">🔥 Creator</div><h3 class="vr-ttl">X's New Monetization Policy Pays 3× More — But Only If You Do This</h3><div class="vr-meter" role="meter" aria-valuenow="85"><div class="vr-meter-fill" style="width:85%;background:#FF6B00"></div></div><div class="vr-shares">Virality: 85 / 100</div></article>
    <article class="vr-card vr-c5"><div class="vr-badge vr-badge-trend">YouTube</div><h3 class="vr-ttl">YouTube Shorts Is Paying Creators 4× More Than TikTok Per View Now</h3><div class="vr-meter" role="meter" aria-valuenow="71"><div class="vr-meter-fill" style="width:71%;background:#FFE600"></div></div><div class="vr-shares">Virality: 71 / 100</div></article>
    <article class="vr-card vr-c6"><div class="vr-badge vr-badge-viral">🕹 Gaming</div><h3 class="vr-ttl">How a 19-Year-Old Gamer Hit 10M Followers in 60 Days With One Strategy</h3><div class="vr-meter" role="meter" aria-valuenow="88"><div class="vr-meter-fill" style="width:88%;background:#FF006E"></div></div><div class="vr-shares">Virality: 88 / 100</div></article>
  </div>
</section>

<!-- ── APP BAND ── -->
<section class="app-band reveal" id="apps" aria-labelledby="app-heading">
  <div class="app-band-header">
    <div>
      <div class="app-band-label">Built-in Tools</div>
      <h2 class="app-band-title" id="app-heading">Apps That <span>Solve</span> Problems</h2>
    </div>
    <a href="#" class="app-band-all">All 14 Apps →</a>
  </div>
  <div class="app-grid">
...
<!-- ── NEWSLETTER ── -->
<section class="nl-section reveal" id="newsletter" aria-labelledby="nl-heading">
  <div class="nl-inner">
    <div class="nl-kicker">Daily Brief</div>
    <h2 class="nl-h" id="nl-heading">Stay on the <span>Wire</span></h2>
    <p class="nl-p">One daily signal. Hip-hop, AI, crypto, streaming, virality — curated for the generation that moves fast.</p>
    <div class="nl-row" role="form" aria-label="Newsletter signup">
      <label for="nl-email" class="sr-only">Email address</label>
      <input class="nl-in" id="nl-email" type="email" placeholder="your@email.com" autocomplete="email" required>
      <button class="nl-bt" id="nlSubmit" type="button">Join →</button>
    </div>
...
<footer role="contentinfo">
  <div class="ft-grid">
    <div>
      <div class="ft-logo">Buzz<span>Wire</span> Daily</div>
      <p class="ft-tag">Where culture breaks first. Multi-niche content platform built for the generation that doesn't wait.</p>
    </div>
    <div>
      <div class="ft-col-h">Sections</div>
      <ul class="ft-links">
        <li><a href="#urban">🎤 Urban Culture</a></li><li><a href="#films">🎬 Movies &amp; TV</a></li>
        <li><a href="#stream">📺 Streaming</a></li><li><a href="#creators">🌟 Creators</a></li>
        <li><a href="#ai">🤖 AI Lab</a></li><li><a href="#crypto">₿ Crypto</a></li><li><a href="#viral">📱 Viral</a></li>
      </ul>
    </div>
    <div>
      <div class="ft-col-h">Apps</div>
      <ul class="ft-links">
        <li><a href="#">Hook Tester</a></li><li><a href="#">WhereToWatch</a></li>
        <li><a href="#">AI Tool Match</a></li><li><a href="#">Token Truth</a></li>
        <li><a href="#">Stream Truth</a></li><li><a href="#">Drop Alert</a></li>
      </ul>
    </div>
    <div>
      <div class="ft-col-h">Company</div>
      <ul class="ft-links">
        <li><a href="#">About</a></li><li><a href="#">Advertise</a></li>
        <li><a href="#">Newsletter</a></li><li><a href="#">Privacy</a></li><li><a href="#">Contact</a></li>
      </ul>
    </div>
  </div>
  <div class="ft-bottom">
    <span>© 2026 Buzzwire Daily · Powered by OpenWork</span>
    <nav class="ft-social" aria-label="Social media">
...
<script>
/* ============================================================
   BUZZWIRE DAILY — MAIN JAVASCRIPT
   WordPress-ready: extract to assets/js/buzzwire.js
   Enqueue after three.js with wp_enqueue_script()
   ============================================================ */
...
// FREQ BARS
document.querySelectorAll('.freq-b').forEach((b,i)=>{b.style.animationDuration=(.5+Math.random()*.8)+'s'});
</script>
</body>
</html>
